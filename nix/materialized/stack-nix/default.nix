  ...
  extras = hackage:
    {
      packages = {
        ...
        cardano-ledger-core = ./.stack-to-nix.cache.24;
        small-steps = ./.stack-to-nix.cache.25;
        small-steps-test = ./.stack-to-nix.cache.26;
        shelley-spec-non-integral = ./.stack-to-nix.cache.27;
        shelley-spec-ledger = ./.stack-to-nix.cache.28;
        shelley-spec-ledger-test = ./.stack-to-nix.cache.29;
        cardano-ledger-shelley-ma = ./.stack-to-nix.cache.30;
        cardano-ledger-shelley-ma-test = ./.stack-to-nix.cache.31;
        cardano-api = ./.stack-to-nix.cache.32;
        cardano-cli = ./.stack-to-nix.cache.33;
        cardano-config = ./.stack-to-nix.cache.34;
        cardano-node = ./.stack-to-nix.cache.35;
        cardano-prelude = ./.stack-to-nix.cache.36;
        cardano-prelude-test = ./.stack-to-nix.cache.37;
        cardano-sl-x509 = ./.stack-to-nix.cache.38;
        flat = ./.stack-to-nix.cache.39;
        goblins = ./.stack-to-nix.cache.40;
        hedgehog-extras = ./.stack-to-nix.cache.41;
        contra-tracer = ./.stack-to-nix.cache.42;
        iohk-monitoring = ./.stack-to-nix.cache.43;
        lobemo-backend-aggregation = ./.stack-to-nix.cache.44;
        lobemo-backend-ekg = ./.stack-to-nix.cache.45;
        lobemo-backend-monitoring = ./.stack-to-nix.cache.46;
        lobemo-backend-trace-forwarder = ./.stack-to-nix.cache.47;
        lobemo-scribe-systemd = ./.stack-to-nix.cache.48;
        tracer-transformers = ./.stack-to-nix.cache.49;
        purescript-bridge = ./.stack-to-nix.cache.50;
        io-classes = ./.stack-to-nix.cache.51;
        io-sim = ./.stack-to-nix.cache.52;
        monoidal-synchronisation = ./.stack-to-nix.cache.53;
        network-mux = ./.stack-to-nix.cache.54;
        ouroboros-consensus = ./.stack-to-nix.cache.55;
        ouroboros-consensus-test = ./.stack-to-nix.cache.56;
        ouroboros-consensus-byron = ./.stack-to-nix.cache.57;
        ouroboros-consensus-byronspec = ./.stack-to-nix.cache.58;
        ouroboros-consensus-byron-test = ./.stack-to-nix.cache.59;
        ouroboros-consensus-shelley = ./.stack-to-nix.cache.60;
        ouroboros-consensus-shelley-test = ./.stack-to-nix.cache.61;
        ouroboros-consensus-cardano = ./.stack-to-nix.cache.62;
        ouroboros-consensus-cardano-test = ./.stack-to-nix.cache.63;
        ouroboros-network = ./.stack-to-nix.cache.64;
        ouroboros-network-framework = ./.stack-to-nix.cache.65;
        ouroboros-network-testing = ./.stack-to-nix.cache.66;
        typed-protocols = ./.stack-to-nix.cache.67;
        typed-protocols-examples = ./.stack-to-nix.cache.68;
        cardano-client = ./.stack-to-nix.cache.69;
        ntp-client = ./.stack-to-nix.cache.70;
        ouroboros-consensus-mock = ./.stack-to-nix.cache.71;
        freer-extras = ./.stack-to-nix.cache.72;
        playground-common = ./.stack-to-nix.cache.73;
        plutus-chain-index = ./.stack-to-nix.cache.74;
        plutus-contract = ./.stack-to-nix.cache.75;
        plutus-core = ./.stack-to-nix.cache.76;
        plutus-ledger = ./.stack-to-nix.cache.77;
        plutus-ledger-api = ./.stack-to-nix.cache.78;
        plutus-pab = ./.stack-to-nix.cache.79;
        plutus-tx = ./.stack-to-nix.cache.80;
        plutus-tx-plugin = ./.stack-to-nix.cache.81;
        plutus-use-cases = ./.stack-to-nix.cache.82;
        plutus-ghc-stub = ./.stack-to-nix.cache.83;
        prettyprinter-configurable = ./.stack-to-nix.cache.84;
        quickcheck-dynamic = ./.stack-to-nix.cache.85;
        word-array = ./.stack-to-nix.cache.86;
        servant-purescript = ./.stack-to-nix.cache.87;
        Win32-network = ./.stack-to-nix.cache.88;
        };
